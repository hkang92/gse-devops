...
```
---
 - **Tip 3: Verify the token to access the registry is valid**
...
```
---
- **Tip 4: Check that the service account image has a push and pull secret**
...
```
---
- **Tip 5: Check to make sure all variable substituion is using $() as of Tekton Pipeline v0.7.0**
